        ...
        <div class="w-full max-w-md mt-10 lg:mt-0">
            ...
            <form action="/login" method="POST" class="space-y-5">
                ...
                <div class="relative mt-6">
                    ...
                    <div class="relative flex justify-center text-sm"><span class="bg-[#FAF9F6] px-4 text-gray-400">atau</span></div>
                </div>

                <a href="{{ route('auth.google.redirect') }}"
                    class="mt-6 w-full flex items-center justify-center gap-3 py-3.5 border border-gray-200 hover:border-gray-300 rounded-xl bg-white hover:bg-gray-50 transition text-sm font-medium text-gray-700 shadow-sm">
